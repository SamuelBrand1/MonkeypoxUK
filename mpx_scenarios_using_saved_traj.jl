...
scatter(wks[3:end],detected_cases[1][:,1])

scatter!(wks_reversion,projections_reversions_4wk_rev[2000].detected_cases[:,1])
scatter!(wks_reversion,projections_reversions_12wk_rev[2000].detected_cases[:,1])
scatter!(wks_no_vacs,projections_reversions_4wk_rev_no_vac[2000].detected_cases[:,1])
scatter!(wks_no_vacs,projections_reversions_12wk_rev_no_vac[2000].detected_cases[:,1])
