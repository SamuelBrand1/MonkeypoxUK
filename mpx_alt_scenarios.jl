...
cum_cases_forwards_novac =
    [cumsum(x[1][(d1+1):end, :], dims=1) for x in preds_and_incidence_interventions_novac_4wkrev]
...
cum_cases_forwards_novac =
    [cumsum(x[1][(d1+1):end, :], dims=1) for x in preds_and_incidence_interventions_novac_12wkrev]
...
plot!(
    ...
    ribbon=(cred_int_novac_12wk.lb_pred_10[d_proj:end, 1], cred_int_novac_12wk.ub_pred_10[d_proj:end, 1]),
    lw=3,
    color=:black,
    fillalpha=0.2,
...
plot!(
    ...
    ribbon=(cred_int_novac_4wk.lb_pred_10[d_proj:end, 1], cred_int_novac_4wk.ub_pred_10[d_proj:end, 1]),
    lw=3,
    color=2,
    fillalpha=0.2,
